...
academy.  You tell the one Gothon joke you know: Lbge zbgure
vf fb sng, jura fur fvgf nebhaq ubhfr, fur fvgf nebhaq
gur ubhfr. The Gothon stops, tries not to laugh, the busts
out laughing and can't move. While he is laughing you run up
...
There's a keypad lock on th ebox and you need the code to
...
out. You grap the neutron bomb and run as fast as you can
...
shoots your right in the back killing you. As you die you
see another Gothon frantically try to disarm the bomb. You
die knowing the will probably blow up when it goes off.
""",
    "TheBridge_place_bomb": """
You point your blaster at the bomb under your arm and the 
Gothons put their hands up an start to sweat. You inch
...
like hardly any Gothons are on the ship, so you run is
...
""",
    "EscapePod_death": """
You jump into the pod {guess} and hit the eject button. The pod
